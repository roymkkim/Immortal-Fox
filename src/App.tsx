  ...
  return (
    <div className="relative w-full h-screen overflow-hidden font-sans">
      ...
      <div className="absolute top-10 left-10 flex flex-col pointer-events-none select-none">
        <h1
          className={`text-sm font-light tracking-[0.8em] uppercase ${brandColorClass} opacity-90`}
        >
          The Immortal Fox
        </h1>
      </div>
      ...
      <div className="absolute top-10 right-10 flex flex-col items-end pointer-events-none select-none">
        <span
          className={`text-[10px] font-medium uppercase tracking-[0.4em] mb-4 ${uiColorClass} opacity-60`}
        >
          MUSHROOMS
        </span>
        ...
        <div className="mt-4">
          <span
            className={`text-[9px] font-semibold ${
              mushroomsCollected >= 5 ? 'text-[#ffd700]' : uiColorClass
            } tracking-[0.3em] uppercase transition-colors duration-500`}
          >
            {mushroomsCollected >= 5
              ? 'Find the Gold Mushroom for Immunity'
              : `${mushroomsCollected} / 5 Found`}
          </span>
        </div>
      </div>
      ...
      <div className="absolute bottom-10 left-10 select-none pointer-events-none">
        <div
          className={`text-[9px] uppercase tracking-[0.4em] flex flex-col space-y-3 ${uiColorClass} opacity-70`}
        >
